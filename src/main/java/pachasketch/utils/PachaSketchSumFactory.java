...
public class PachaSketchSumFactory {
    public static PachaSketchSum buildWithSizeParameters(int[] catColMap, int[] numColMap,
    ...
    public static PachaSketchSum buildWithErrorParameters(int[] catColMap, int[] numColMap,
                                                       int levels, int[] bases,
                                                       ADTree adTree, MaterializedCombinations materialized,
    ...
    public static PachaSketchSum buildWithErrorParametersWD(int[] catColMap, int[] numColMap,
                                                            int levels, int[] bases,
                                                            ADTree adTree, MaterializedCombinations materialized,
                                                            double falsePositiveRate,
                                                            int width, int depth,
