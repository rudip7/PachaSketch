...
import pachasketch.utils.PachaSketchMinFactory;

import java.io.IOException;
import java.util.Arrays;
import java.util.List;

public class PreparePachaSketchMin {


    public static PachaSketchMin forTpch(double falsePositiveRate, int width, int depth, int levels, int nElements) throws IOException {
        ...
        return PachaSketchMinFactory.buildWithErrorParametersWD(
    ...
    public static PachaSketchMin loadTpchWD(double falsePositiveRate, int width, int depth, int levels, String filePath) throws IOException {
        int nElements = Utils.countRowsInCsv(filePath);
        PachaSketchMin pachaSketch = forTpch(falsePositiveRate, width, depth, levels, nElements);
