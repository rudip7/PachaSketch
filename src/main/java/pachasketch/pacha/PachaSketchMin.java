...
public class PachaSketchMin implements SketchWithAggregateColumn {
...
//    }
    ...
    public PachaQueryResult query(List<Object> query, boolean detailed, boolean debug){
        ...
        long estimate = Integer.MAX_VALUE;
        ...
        for (Integer level : queryRegions.keySet()){
            ...
            estimate = Math.min(estimate, regionEstimate);
        }
    ...
    public double getSizeInMB(){
        ...
        for (MinSketch cms : baseSketches) {
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        PachaSketchMin other = (PachaSketchMin) obj;
